...
CoD.ServerList.COLUMN_LOCK         = 1
CoD.ServerList.COLUMN_MODS         = 2
CoD.ServerList.COLUMN_SERVERNAME   = 3
CoD.ServerList.COLUMN_MAPNAME      = 4
CoD.ServerList.COLUMN_ZMROUND_MPHC = 5
CoD.ServerList.COLUMN_GAMEMODE     = 6
CoD.ServerList.COLUMN_PLAYERS      = 7
CoD.ServerList.COLUMN_PING         = 8

CoD.ServerList.Columns = {}

CoD.ServerList.Columns[CoD.ServerList.COLUMN_LOCK] = {}
CoD.ServerList.Columns[CoD.ServerList.COLUMN_LOCK].Width = 30
CoD.ServerList.Columns[CoD.ServerList.COLUMN_LOCK].Icon = "menu_mp_lobby_locked"

CoD.ServerList.Columns[CoD.ServerList.COLUMN_SERVERNAME] = {}
CoD.ServerList.Columns[CoD.ServerList.COLUMN_SERVERNAME].Width = 300
CoD.ServerList.Columns[CoD.ServerList.COLUMN_SERVERNAME].Text = UIExpression.ToUpper(nil, Engine.Localize("MENU_SERVERNAME"))

CoD.ServerList.Columns[CoD.ServerList.COLUMN_MAPNAME] = {}
CoD.ServerList.Columns[CoD.ServerList.COLUMN_MAPNAME].Width = 130
CoD.ServerList.Columns[CoD.ServerList.COLUMN_MAPNAME].Text = Engine.Localize("MENU_MAP_NAME_CAPS")

CoD.ServerList.Columns[CoD.ServerList.COLUMN_ZMROUND_MPHC] = {}
CoD.ServerList.Columns[CoD.ServerList.COLUMN_ZMROUND_MPHC].Width = 30
if CoD.isZombie then
	CoD.ServerList.Columns[CoD.ServerList.COLUMN_ZMROUND_MPHC].Icon = "hud_chalk_5"
	CoD.ServerList.Columns[CoD.ServerList.COLUMN_ZMROUND_MPHC].IconButText = true
	CoD.ServerList.Columns[CoD.ServerList.COLUMN_ZMROUND_MPHC].IconColor = {
		r = 0.666,
		g = 0,
		b = 0
	}
else
	CoD.ServerList.Columns[CoD.ServerList.COLUMN_ZMROUND_MPHC].Icon = "hud_status_dead"
end

CoD.ServerList.Columns[CoD.ServerList.COLUMN_GAMEMODE] = {}
CoD.ServerList.Columns[CoD.ServerList.COLUMN_GAMEMODE].Width = 130
CoD.ServerList.Columns[CoD.ServerList.COLUMN_GAMEMODE].Text = Engine.Localize("MENU_GAME_MODE_CAPS")
...
CoD.ServerList.Columns[CoD.ServerList.COLUMN_MODS] = {}
CoD.ServerList.Columns[CoD.ServerList.COLUMN_MODS].Width = 30
CoD.ServerList.Columns[CoD.ServerList.COLUMN_MODS].Icon = "menu_mp_fileshare_custom"
...
CoD.ServerList.SortFunc = function(server1, server2)
	...
	elseif sortHeader == CoD.ServerList.COLUMN_GAMEMODE then
	...
	elseif sortHeader == CoD.ServerList.COLUMN_MODS then
...
CoD.ServerList.GetButtonData = function (LocalClientIndex, index, element, parent)
	...
	local ColumnValues = {}
	ColumnValues[CoD.ServerList.COLUMN_LOCK] = element.serverListButton.server.has_password
	ColumnValues[CoD.ServerList.COLUMN_SERVERNAME] = element.serverListButton.server.hostname
	ColumnValues[CoD.ServerList.COLUMN_MAPNAME] = element.serverListButton.server.displayable_map
	if CoD.isZombie then
		ColumnValues[CoD.ServerList.COLUMN_ZMROUND_MPHC] = element.serverListButton.server.rounds
	else
		ColumnValues[CoD.ServerList.COLUMN_ZMROUND_MPHC] = element.serverListButton.server.is_hardcore
	end
	ColumnValues[CoD.ServerList.COLUMN_GAMEMODE] = element.serverListButton.server.displayable_gametype
	...
	ColumnValues[CoD.ServerList.COLUMN_MODS] = element.serverListButton.server.mod ~= ""
